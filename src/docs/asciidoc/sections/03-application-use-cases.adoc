...
UI -> Admin: typed snapshot getters
...
jobs.scheduleAtFixedRate(() ->
        admin.refreshConfig(AdminMessage.ConfigType.SECURITY_CONFIG)
             .thenCompose(cfgSec -> admin.refreshModuleConfig(AdminMessage.ModuleConfigType.MQTT_CONFIG))
             .exceptionally(ex -> {
